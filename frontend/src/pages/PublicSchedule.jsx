    ...
    <div className="min-h-screen bg-slate-50 selection:bg-blue-600 selection:text-white flex flex-col font-sans">
      ...
      <main className="max-w-5xl w-full mx-auto px-4 py-6 sm:py-8 space-y-6 flex-1">
        ...
        <div className="bg-white rounded-2xl p-4 sm:p-5 border border-slate-200 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              title="Previous Day"
              className="p-2 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 text-slate-700 transition-colors flex items-center gap-1"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
              </svg>
              <span className="text-xs font-bold hidden sm:inline">Yesterday</span>
            </button>
            <input
              type="date"
              value={date}
              onChange={e => setDate(e.target.value)}
              className="border border-slate-200 rounded-xl px-3 py-1.5 text-xs font-semibold bg-white text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer shadow-xs"
            />
            <button
              onClick={() => setDate(d => shiftDate(d, +1))}
              aria-label="Next day"
              ...
              className="p-2 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 text-slate-700 transition-colors flex items-center gap-1"
            >
              <span className="text-xs font-bold hidden sm:inline">Tomorrow</span>
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {loading ? (
          ...
          /* ════════════════════════════════════════════════════════════════
             VERTICAL ROADMAP VIEW (ONLY VIEW)
          ════════════════════════════════════════════════════════════════ */
            ...
            <div className="flex items-center justify-between border-b border-slate-100 pb-4 mb-6">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-base font-extrabold text-slate-900 tracking-tight">
                  {isToday ? "Today's Event Roadmap" : isPast ? "Past Event Roadmap" : "Upcoming Event Roadmap"}
                </h3>
              </div>
              <span className="text-xs text-slate-400 font-medium">09:00 AM – 10:00 PM</span>
            </div>
              ...
              <div className="relative py-12 px-4 max-w-lg mx-auto text-center">
                <div className="relative z-10 flex flex-col items-center">
                  ...
                  <h4 className="text-base font-bold text-slate-900">
                    {isPast ? 'No Bookings Found on This Date' : 'All Halls Available'}
                  </h4>
                  <p className="text-xs text-slate-500 max-w-xs mt-1 leading-relaxed">
                    {isPast
                      ? 'No events were recorded for the selected date.'
