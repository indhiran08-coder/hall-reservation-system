...
const BookingCard = ({ booking, onCancel, onDelete, compact = false }) => {
  const { id, hall, purpose, date, start_time, end_time, status, participants } = booking;
  ...
  // Only future confirmed bookings can be soft-cancelled
  const canCancel = status === 'confirmed' && timeLabel === 'upcoming';
  // Any booking can be permanently deleted
